...
from mqns.network.proactive.forwarder import ProactiveForwarderCounters
...
class ReactiveForwarder(Application[QNode]):
    """
    ...
    CLASSIC_CONTROL_HANDLERS: dict[str, Callable[["ReactiveForwarder", Any], None]] = {}
    CLASSIC_SIGNALING_HANDLERS: dict[str, Callable[["ReactiveForwarder", Any, FibEntry], None]] = {}
    ...
    def _su_parallel(self, msg: SwapUpdateMsg, fib_entry: FibEntry, new_epr: Entanglement | None):
        ...
        if merged_epr is not None:
            ...
            destination.get_app(ReactiveForwarder).remote_swapped_eprs[merged_epr.name] = merged_epr
